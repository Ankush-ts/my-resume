...
const TemplateCard = ({ data, thumbnail, settemplate, updatetemplate, resumedataprops }) => {
        ...
        <div>
          ...
          {isHovered && (
           ...
           <button
              ...
              className="w-auto bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded text-sm"
              onClick={onSubmit}
              onMouseEnter={handleHover} // Handle hover enter event
              onMouseLeave={handleHoverExit} // Handle hover exit event
            >
